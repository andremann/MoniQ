...
public class ReportsController {
	...
	private void testControl(Control ctrl) throws IllegalAccessException, ClassNotFoundException, InstantiationException {
		List<Observation> observations = new ArrayList<>();
		for (Selector s : ctrl.getSelectors()) {
			observations.addAll(observationDao.findKLastObservations(ctrl.getMonitoringScenario(),
					s.getMetric(),
					s.getLabelsConditions(),
					s.getSamples()));
		}
