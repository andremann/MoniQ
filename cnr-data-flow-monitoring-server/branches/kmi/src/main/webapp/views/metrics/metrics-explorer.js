            ...
            $http.get('ajax/scenarios/' + $routeParams.scenario + '/metrics/' + $routeParams.metric + "/observations" + labelParam)
                .success(
                    function (data) {
                        ...
                        var c3types = {};
                        $scope.metricsExplorer.labelValues.forEach(
                            function (entry) {
                                c3types[entry] = 'step';
                            }
                        );
                        c3.generate({
                            ...
                            data: {
                                json: fillIn($scope.metricsExplorer.observations, $scope.metricsExplorer.labelValues),
                                keys: {
                                    x: 'timestamp',
                                    value: $scope.metricsExplorer.labelValues
                                },
                                types: c3types
                            },
                            point: {
