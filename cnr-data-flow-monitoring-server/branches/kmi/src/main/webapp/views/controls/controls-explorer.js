var module = angular.module('controlsExplorer', ['ngRoute', 'ui.select', 'ngSanitize', 'akoenig.deckgrid', 'jlareau.pnotify', 'angular-json-editor']);

module.filter('labels', function () {
