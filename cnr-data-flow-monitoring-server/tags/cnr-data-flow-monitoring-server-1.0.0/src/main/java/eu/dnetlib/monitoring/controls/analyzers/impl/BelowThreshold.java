...
public class BelowThreshold extends Analyzer {
    ...
    public String getName() {
        return "Below 0.9 threshold";
    }

    @Override
    public String getDescription() {
        return "Works with 1 selector. Checks if ALL the provided observations are below 0.9 threshold.";
    }
